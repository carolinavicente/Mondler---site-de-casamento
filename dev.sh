...
GREEN='\033[00;32m'
YELLOW='\e[0;33m'
HOST_PROD=myproject.example.com
...
workon myproject  # Change this to your project's name
...
function dkrun_prod {
    ...
    docker rm myproject
    docker run --name myproject -d --env-file /home/ubuntu/myproject.env \
        -p 3000:3000 -p 8000:8000 \
        -v /home/ubuntu/dkdata/myproject:/dkdata \
        myproject start_web.sh
}
...
echo_green "Welcome to myproject's dev env"
